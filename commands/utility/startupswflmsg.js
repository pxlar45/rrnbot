...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const image = "https://media.discordapp.net/attachments/1261462831220658196/1288963547174539344/RRN_swfl_startup.png?ex=66fe5899&is=66fd0719&hm=733a609d3131ee703312f8967ac784193d28186d7099eaa4338bd97dc173dd78&=&format=webp&quality=lossless";

        const embed1 = new EmbedBuilder()
            .setTitle('RRN | Swfl Startup')
            .setDescription("> Hey <@&1287409353074282598>, Welcome to <#1287393049772560437>, this is where our server staff's will host **[SouthWest Florida Beta](https://www.roblox.com/games/5104202731/Southwest-Florida-Beta)** Roleplay Sessions for you Civilians to enjoy. If you want to get notified for a session there is a red button named 'Session Ping' if you click it, it gives you a A role, which pings you everytime a session occurs.")
